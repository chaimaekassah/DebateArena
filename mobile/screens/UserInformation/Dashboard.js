...
const { dark, yellow, blue, lightPink, pink, white, grey, brand, green } =
  Colors;
    ...
    try {
      ...
      if (response.data) {
        ...
        await AsyncStorage.setItem(
          'badgeMom',
          data.badgeActuel?.nom || 'Nouveau',
        );
        await AsyncStorage.setItem(
          'badgeCategorie',
          data.badgeActuel?.categorie || 'BRONZE',
        );
      }
    } catch (error) {
      ...
      const badgeCategorie =
        (await AsyncStorage.getItem('badgeCategorie')) || 'BRONZE';
      const totalDebats =
      ...
      >
        <InnerContainer style={{ paddingBottom: 30 }}>
          {error && (
            ...
            >
              <Label
                style={{ color: dark, marginBottom: 10, textAlign: 'center' }}
              >
                {error}
              </Label>
              <StyledButton
          ...
          >
            ...
            <View
              style={{
                backgroundColor: getBadgeColor(
                  dashboardData.badgeActuel?.categorie,
                ),
                paddingVertical: 8,
            ...
            >
              <ButtonText style={{ color: white, fontSize: 16 }}>
                <Ionicons name="create-outline" size={16} /> Modifier le profil
              </ButtonText>
            </StyledButton>
          </Shadow>
          ...
          >
            ...
            >
              <Text style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: 12 }}>
                {dashboardData.score} /{' '}
                {dashboardData.score + dashboardData.pointsPourNiveauSuivant}{' '}
                points
              </Text>
              <View
                style={{
          ...
          <View style={{ width: '100%', marginTop: 20, marginBottom: 30 }}>
            ...
            >
              <ButtonText style={{ color: white, fontSize: 16 }}>
                <Ionicons name="log-out-outline" size={16} /> Déconnexion
              </ButtonText>
            </StyledButton>
          </View>
        </InnerContainer>
